...
* Epoch:
  ...
  * isFinalized (boolean): 
  * When it is started: 
  * Amunt of blocks inside: 
  * Attestations inside: 
  * Voted Ether inside: 
  * Proposer/Attester slashing inside (if any): 
* Slot (Block at this slot):
  * Slot number: 
  * Which epoch: 
...
在本地启动Slashing没有增加额外的参数。

Prysm团队有一个ethereumapis的插件，似乎可以获得更多的数据，让我研究研究
