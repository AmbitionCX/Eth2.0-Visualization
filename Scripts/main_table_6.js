...
const write_main_table = async () => {
	for ( let i = 3880800; i < 4000030; i++ ){
		...
		await db.query(sql`
		INSERT INTO s_main_table_6 (f_epoch, f_slot, f_casper_y, f_casper_y_balance, f_casper_n, f_casper_n_balance, f_not_vote, f_not_vote_balance, f_ghost_selection)
